...
import com.com.hamsoft.captaincook.Model.Food;
import com.com.hamsoft.captaincook.Model.Order;
import com.com.hamsoft.captaincook.ViewHolder.FoodViewHolder;
    ...
    private void loadListFood(String categoryId) {
        ...
        adapter = new FirebaseRecyclerAdapter<Food, FoodViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull FoodViewHolder holder, final int position, @NonNull final Food model) {
                holder.food_name.setText(model.getName());
                holder.food_price.setText(String.format("N %s", model.getPrice().toString()));
                Picasso.get().load(model.getImage()).into(holder.food_image);
                ...
                holder.quick_cart.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(FoodList.this, "Item Added to Cart", Toast.LENGTH_SHORT).show();
                    }
                });
